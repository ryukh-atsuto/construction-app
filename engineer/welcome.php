...
<style>
    ...
    .orb-2 { width: 200px; height: 200px; background: #f97316; bottom: -50px; left: -50px; animation-delay: 2s; }
    @keyframes float {
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-white space-y-6 animate-fade-in-up">
                <div class="inline-flex items-center px-4 py-1.5 rounded-full bg-blue-500/20 border border-blue-400/30 backdrop-blur-md text-sm font-bold text-blue-100 mb-2 shadow-inner">
                ...
                <p class="text-xl text-white/90 max-w-lg font-medium drop-shadow-sm leading-relaxed">
                    Your hub for technical consultations, structural analysis, and site inspections. Everything is ready for your review.
                </p>
                ...
                <div class="flex space-x-4 pt-4">
                    <a href="../dashboard.php" class="relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-bold text-white transition-all duration-300 bg-brand-600 rounded-xl group hover:bg-brand-500 hover:scale-105 hover:shadow-[0_0_40px_-10px_rgba(14,165,233,0.5)]">
                        ...
                        <span class="relative flex items-center">Access Dashboard <i class="fas fa-arrow-right ml-2 group-hover:translate-x-1 transition-transform"></i></span>
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 perspective-1000">
                ...
                <div class="glass-panel p-6 rounded-2xl shadow-2xl relative group card-3d" data-tilt data-tilt-max="15" data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.5">
                    <div class="absolute top-4 right-4 text-brand-600 opacity-80 group-hover:opacity-100 transition-opacity">
                        <i class="fas fa-calendar-check text-4xl transform -rotate-12"></i>
                    </div>
                    <div class="card-content">
                        <p class="text-sm uppercase tracking-wider text-gray-600 font-bold mb-1">Upcoming Consultations</p>
                ...
                <!-- Data Card 2 -->
                <div class="glass-panel p-6 rounded-2xl shadow-2xl relative group card-3d" data-tilt data-tilt-max="15" data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.5">
                    <div class="absolute top-4 right-4 text-orange-600 opacity-80 group-hover:opacity-100 transition-opacity">
