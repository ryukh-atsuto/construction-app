    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-white space-y-6 animate-fade-in-up">
                <div
                    class="inline-flex items-center px-4 py-1.5 rounded-full bg-green-500/20 border border-green-400/30 backdrop-blur-md text-sm font-bold text-green-100 mb-2 shadow-inner">
                ...
                <h1 class="text-6xl font-black tracking-tight leading-tight">
                    ...
                    <span
                        class="block text-white drop-shadow-md"><?= htmlspecialchars($_SESSION['name'] ?? 'Manager') ?></span>
                </h1>
                ...
                <div class="flex space-x-4 pt-4">
                    <a href="../dashboard.php"
                        class="relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-bold text-white transition-all duration-300 bg-brand-600 rounded-xl group hover:bg-brand-500 hover:scale-105 hover:shadow-[0_0_40px_-10px_rgba(34,197,94,0.5)]">
                        <span
                        ...
                        <span class="relative flex items-center">Manage Sites <i
