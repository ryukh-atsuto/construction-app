...
<style>
    ...
    .orb {
        ...
        filter: blur(80px);
        opacity: 0.3;
        /* Reduced opacity to prevent washout */
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-white space-y-6 animate-fade-in-up">
                <div
                    class="inline-flex items-center px-3 py-1 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm text-sm font-medium text-sky-200 mb-2">
                ...
                <h1 class="text-6xl font-black tracking-tight leading-tight text-white shadow-sm">
                    ...
                    <?= htmlspecialchars($_SESSION['name'] ?? 'Owner') ?>
                </h1>
                ...
                <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 pt-4">
                    <a href="../dashboard.php"
                        ...
                        <span class="relative flex items-center">View Portfolio <i
                                class="fas fa-arrow-right ml-2 group-hover:translate-x-1 transition-transform"></i></span>
                    </a>
                    <a href="ai_estimate.php"
                        class="relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-bold text-white transition-all duration-300 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl group hover:from-purple-700 hover:to-indigo-700 hover:scale-105 hover:shadow-[0_0_40px_-10px_rgba(124,58,237,0.5)]">
                        <span
                            class="absolute inset-x-0 bottom-0 h-[2px] bg-white transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
                        <span class="relative flex items-center"><i class="fas fa-robot mr-2"></i>AI Estimator</span>
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 perspective-1000">
                <!-- Card 1 -->
                <div class="glass-panel p-6 rounded-2xl shadow-xl relative group card-3d" data-tilt data-tilt-max="15"
                    data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.5">
                    <div
                        class="absolute top-4 right-4 text-sky-600 opacity-80 group-hover:opacity-100 transition-opacity">
                ...
                <div class="glass-panel p-6 rounded-2xl shadow-xl relative group card-3d" data-tilt data-tilt-max="15"
                    data-tilt-speed="400">
                    <div
                        class="absolute top-4 right-4 text-green-600 opacity-80 group-hover:opacity-100 transition-opacity">
