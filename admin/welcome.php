    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-white space-y-6 animate-fade-in-up">
                <div
                    class="inline-flex items-center px-4 py-1.5 rounded-full bg-indigo-500/20 border border-indigo-400/30 backdrop-blur-md text-sm font-bold text-indigo-100 mb-2 shadow-inner">
                ...
                <h1 class="text-6xl font-black tracking-tight leading-tight">
                    ...
                    <span
                        class="block text-white drop-shadow-md"><?= htmlspecialchars($_SESSION['name'] ?? 'Admin') ?></span>
                </h1>
                <p class="text-xl text-white/90 max-w-lg font-medium drop-shadow-sm leading-relaxed">
                    System overview at a glance. Manage users, approve projects, and monitor platform health in
                    real-time.
                </p>

                <div class="flex space-x-4 pt-4">
                    <a href="../dashboard.php"
                        class="relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-bold text-white transition-all duration-300 bg-indigo-600 rounded-xl group hover:bg-indigo-500 hover:scale-105 hover:shadow-[0_0_40px_-10px_rgba(99,102,241,0.5)]">
                        <span
                        ...
                        <span class="relative flex items-center">Manage System <i
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 perspective-1000">
                ...
                <div class="glass-panel p-6 rounded-2xl shadow-2xl relative group card-3d" data-tilt data-tilt-max="15"
                    ...
                    <div
                        class="absolute top-4 right-4 text-indigo-500 opacity-80 group-hover:opacity-100 transition-opacity">
                        <i class="fas fa-building text-3xl"></i>
                    </div>
                    <div class="card-content">
                        <p class="text-xs uppercase tracking-wider text-gray-600 dark:text-gray-400 font-bold mb-1">
                            Total Projects</p>
                        <h3 class="text-3xl font-extrabold text-gray-900 dark:text-white"><?= $total_projects ?></h3>
                    </div>
                </div>
                ...
                <div class="glass-panel p-6 rounded-2xl shadow-2xl relative group card-3d" data-tilt data-tilt-max="15"
                    data-tilt-speed="400">
                    <div
                        class="absolute top-4 right-4 text-amber-500 opacity-80 group-hover:opacity-100 transition-opacity">
                        <i class="fas fa-clipboard-check text-3xl"></i>
                    </div>
                    <div class="card-content">
                        <p class="text-xs uppercase tracking-wider text-gray-600 dark:text-gray-400 font-bold mb-1">
                            Pending Approval</p>
                        <h3 class="text-3xl font-extrabold text-gray-900 dark:text-white"><?= $pending_projects ?></h3>
                        <?php if ($pending_projects > 0): ?>
                            <div class="mt-2 text-xs text-amber-600 dark:text-amber-400 font-bold animate-pulse">Action
                                Required</div>
                        <?php endif; ?>
                    </div>
                </div>

                <div class="glass-panel p-6 rounded-2xl shadow-2xl relative group card-3d sm:col-span-2" data-tilt
                    data-tilt-max="10" data-tilt-speed="400">
                    <div class="flex items-center space-x-4 card-content">
                        <div
                            class="h-12 w-12 rounded-full bg-green-100 dark:bg-green-900/40 flex items-center justify-center text-green-600 dark:text-green-400">
                            <i class="fas fa-users text-xl"></i>
                        </div>
                        <div>
                            <p class="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 font-bold">
                                Active User Base</p>
                            <h3 class="text-2xl font-extrabold text-gray-800 dark:text-white"><?= $users_count ?> Users
                            </h3>
                        </div>
                        <div class="ml-auto">
                            <span
